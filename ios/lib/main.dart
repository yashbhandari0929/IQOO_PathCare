...
Future<void> main() async {
  ...
  await Supabase.initialize(
    ...
    anonKey:
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRscnpmbGVpdnJveGdmc2x1ZG15Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjkzNDM4ODgsImV4cCI6MjA4NDkxOTg4OH0._LqcMtiHo7cKi0oJKGhcAKQSRglIKpRVFbEd2xwm9fU',
  );
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          '/doctor-dashboard': (context) =>
              DoctorDashboard(), // ✅ CHANGED: Now points to actual DoctorDashboard
