...
class BookingService {
  ...
  Future<List<String>> getAvailableTimeSlots({
    ...
    try {
      ...
      final List<Map<String, dynamic>> tests = List<Map<String, dynamic>>.from(
        testsData,
      );
      ...
      final List<Map<String, dynamic>> rooms = List<Map<String, dynamic>>.from(
        roomsData,
      );
  ...
  Future<void> checkAndCompleteAppointment(String appointmentId) async {
    try {
      ...
      final bool allCompleted = appointmentTests.every(
  ...
  // ============================================================
  Future<void> triggerCompletionCheckForTest(String appointmentTestId) async {
    try {
