    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
            colors: [c.withOpacity(0.09), c.withOpacity(0.02)]),
        borderRadius: BorderRadius.circular(14),
        border: Border.all(color: c.withOpacity(0.28), width: 1.5),
      ),
      child: Column(children: [
        ...
        Row(children: [
          Expanded(child: _statTile(
              ...
              c, Icons.person_outline_rounded)),
          const SizedBox(width: 10),
          Expanded(child: _statTile(
              'Est. wait', '~${count * 8}', 'min',
              const Color(0xFF2563EB), Icons.schedule_rounded)),
        ]),
        ...
        Container(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            Text(
              count == 0 ? 'Room is free — great time to head over'
                  : count <= 2 ? 'Short queue — head over soon'
                  : count <= 4 ? 'Moderate wait — expect some delay'
            ...
            ScaleTransition(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: c.withOpacity(0.45), width: 2.5),
                ),
                child: isNext
                    ? Icon(Icons.notifications_active_rounded, color: c, size: 34)
                  ...
                  children: [
                    ...
                    Row(children: [
                      Icon(Icons.people_alt_rounded, size: 13,
                          color: Colors.grey[500]),
                      const SizedBox(width: 4),
                      Text('$total ${total == 1 ? 'patient' : 'patients'} in room',
                          style: TextStyle(fontSize: 12,
                              color: Colors.grey[500])),
                    ]),
                  ]),
