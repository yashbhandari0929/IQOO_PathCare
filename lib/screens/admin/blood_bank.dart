...
class BloodBank {
  ...
  Map<String, dynamic> toJson() => {
    ...
    'lat': latitude, 'lon': longitude, 'timing': timing,
    'type': type, 'area': area,
  ...
  factory BloodBank.fromOverpass(Map<String, dynamic> el) {
    ...
    final name = tags['name'] as String? ??
        tags['name:en'] as String? ?? 'Blood Bank';
    final phone = tags['phone'] as String? ??
        tags['contact:phone'] as String? ?? 'N/A';
    ...
    return BloodBank(
      id: id, name: name, address: _buildAddress(tags),
      phone: phone, latitude: lat, longitude: lon,
      timing: tags['opening_hours'] as String? ?? 'Hours not listed',
      type: _inferType(tags), area: area,
    );
  }
  ...
  static String _inferType(Map<String, dynamic> t) {
    final op  = ((t['operator:type'] ?? t['ownership'] ?? '') as String).toLowerCase();
    final opr = ((t['operator'] ?? '') as String).toLowerCase();
    if (op.contains('government') || op.contains('public') ||
        opr.contains('govt') || opr.contains('municipal') || opr.contains('bmc'))
      return 'Government';
    if (op.contains('ngo') || op.contains('trust') || op.contains('charity') ||
        opr.contains('red cross') || opr.contains('rotary'))
      return 'Trust';
    return 'Private';
  }
}
...
const List<BloodBank> _localBloodBanks = [
  // ── SOUTH MUMBAI ──────────────────────────────────────────────────────────
  BloodBank(id:'kem_hosp',name:'KEM Hospital Blood Bank',
      address:'Acharya Donde Marg, Parel, Mumbai 400 012',phone:'02224107000',
      latitude:19.0007,longitude:72.8407,timing:'Open 24/7',type:'Government',area:'Parel'),
  BloodBank(id:'sion_hosp',name:'Sion Hospital Blood Bank',
      address:'Dr Ambedkar Rd, Sion (W), Mumbai 400 022',phone:'02224076381',
      latitude:19.0397,longitude:72.8659,timing:'Open 24/7',type:'Government',area:'Sion'),
  BloodBank(id:'nair_hosp',name:'Nair Hospital Blood Bank',
      address:'Dr A L Nair Rd, Mumbai Central, Mumbai 400 008',phone:'02223027444',
      latitude:18.9716,longitude:72.8204,timing:'Open 24/7',type:'Government',area:'Mumbai Central'),
  BloodBank(id:'gt_hosp',name:'GT Hospital Blood Bank',
      address:'Lokmanya Tilak Marg, Fort, Mumbai 400 001',phone:'02222620000',
      latitude:18.9356,longitude:72.8347,timing:'Open 24/7',type:'Government',area:'Fort'),
  BloodBank(id:'jj_hosp',name:'JJ Hospital Blood Bank',
      address:'J J Marg, Nagpada, Byculla, Mumbai 400 008',phone:'02223735555',
      latitude:18.9601,longitude:72.8302,timing:'Open 24/7',type:'Government',area:'Byculla'),
  BloodBank(id:'cama_hosp',name:'Cama & Albless Hospital Blood Bank',
      address:'Mahapalika Marg, Fort, Mumbai 400 001',phone:'02222620555',
      latitude:18.9374,longitude:72.8344,timing:'Open 24/7',type:'Government',area:'Fort'),
  BloodBank(id:'bombay_hosp',name:'Bombay Hospital Blood Bank',
      address:'New Marine Lines, Mumbai 400 020',phone:'02222067676',
      latitude:18.9397,longitude:72.8289,timing:'8 AM – 8 PM',type:'Private',area:'Marine Lines'),
  BloodBank(id:'breach_candy',name:'Breach Candy Hospital Blood Bank',
      address:'60-A Bhulabhai Desai Rd, Breach Candy, Mumbai 400 026',phone:'02223667878',
      latitude:18.9690,longitude:72.8075,timing:'8 AM – 6 PM',type:'Private',area:'Breach Candy'),
  BloodBank(id:'hinduja_mahim',name:'P D Hinduja Hospital Blood Bank',
      address:'Veer Savarkar Marg, Mahim, Mumbai 400 016',phone:'02224447000',
      latitude:19.0359,longitude:72.8417,timing:'Open 24/7',type:'Private',area:'Mahim'),
  BloodBank(id:'wockhardt_south',name:'Wockhardt Hospital Blood Bank',
      address:'1877 Dr Anandrao Nair Rd, Mumbai Central, Mumbai 400 011',phone:'02261784444',
      latitude:18.9705,longitude:72.8218,timing:'Open 24/7',type:'Private',area:'Mumbai Central'),
  // ── BANDRA / WESTERN SUBURBS ──────────────────────────────────────────────
  BloodBank(id:'bhabha_bandra',name:'Bhabha Hospital Blood Bank',
      address:'Bandra (W), Mumbai 400 050',phone:'02226400300',
      latitude:19.0607,longitude:72.8361,timing:'Open 24/7',type:'Government',area:'Bandra West'),
  BloodBank(id:'lilavati',name:'Lilavati Hospital Blood Bank',
      address:'A-791 Bandra Reclamation, Bandra (W), Mumbai 400 050',phone:'02226751000',
      latitude:19.0563,longitude:72.8298,timing:'7 AM – 9 PM',type:'Private',area:'Bandra West'),
  BloodBank(id:'holy_family',name:'Holy Family Hospital Blood Bank',
      address:'St Andrews Rd, Bandra (W), Mumbai 400 050',phone:'02226483900',
      latitude:19.0582,longitude:72.8310,timing:'8 AM – 8 PM',type:'Private',area:'Bandra West'),
  BloodBank(id:'cooper_vile',name:'Cooper Hospital Blood Bank',
      address:'Bhaktivedanta Swami Marg, Juhu, Vile Parle (W), Mumbai 400 056',phone:'02226207254',
      latitude:19.1029,longitude:72.8395,timing:'Open 24/7',type:'Government',area:'Vile Parle West'),
  // ── ANDHERI / JOGESHWARI ──────────────────────────────────────────────────
  BloodBank(id:'seven_hills',name:'Seven Hills Hospital Blood Bank',
      address:'Marol Maroshi Rd, Andheri (E), Mumbai 400 059',phone:'02267676767',
      latitude:19.1138,longitude:72.8800,timing:'Open 24/7',type:'Private',area:'Andheri East'),
  BloodBank(id:'kokilaben',name:'Kokilaben Dhirubhai Ambani Hospital Blood Bank',
      address:'Rao Saheb Achutrao Patwardhan Marg, Andheri (W), Mumbai 400 053',phone:'02230999999',
      latitude:19.1296,longitude:72.8274,timing:'Open 24/7',type:'Private',area:'Andheri West'),
  BloodBank(id:'bharat_ratna',name:'Dr Babasaheb Ambedkar Hospital Blood Bank',
      address:'Jogeshwari (E), Mumbai 400 060',phone:'02228206600',
      latitude:19.1365,longitude:72.8609,timing:'Open 24/7',type:'Government',area:'Jogeshwari East'),
  // ── BORIVALI / KANDIVALI ──────────────────────────────────────────────────
  BloodBank(id:'bhagwati_borivali',name:'Bhagwati Hospital Blood Bank',
      address:'Western Express Hwy, Borivali (E), Mumbai 400 066',phone:'02228980000',
      latitude:19.2293,longitude:72.8626,timing:'Open 24/7',type:'Government',area:'Borivali East'),
  BloodBank(id:'shatabdi_kandivali',name:'Shatabdi Hospital Blood Bank',
      address:'Kandivali (E), Mumbai 400 101',phone:'02228860000',
      latitude:19.2067,longitude:72.8603,timing:'Open 24/7',type:'Government',area:'Kandivali East'),
  // ── GHATKOPAR / MULUND ────────────────────────────────────────────────────
  BloodBank(id:'rajawadi_ghatkopar',name:'Rajawadi Hospital Blood Bank',
      address:'LBS Marg, Ghatkopar (E), Mumbai 400 077',phone:'02225014141',
      latitude:19.0779,longitude:72.9147,timing:'Open 24/7',type:'Government',area:'Ghatkopar East'),
  BloodBank(id:'fortis_mulund',name:'Fortis Hospital Blood Bank',
      address:'Mulund – Goregaon Link Rd, Mulund (W), Mumbai 400 078',phone:'02267125500',
      latitude:19.1727,longitude:72.9521,timing:'8 AM – 8 PM',type:'Private',area:'Mulund West'),
  // ── SION / CHEMBUR ────────────────────────────────────────────────────────
  BloodBank(id:'ltmg_sion',name:'Lokmanya Tilak Municipal General Hospital Blood Bank',
      address:'Dr Babasaheb Ambedkar Rd, Sion, Mumbai 400 022',phone:'02224076363',
      latitude:19.0398,longitude:72.8651,timing:'Open 24/7',type:'Government',area:'Sion'),
  BloodBank(id:'chembur_hosp',name:'Chembur Hospital & Research Centre Blood Bank',
      address:'Chembur Naka, Mumbai 400 071',phone:'02225200200',
      latitude:19.0605,longitude:72.9002,timing:'8 AM – 8 PM',type:'Private',area:'Chembur'),
  // ── TRUST / NGO ───────────────────────────────────────────────────────────
  BloodBank(id:'idonate_dadar',name:'iDonate Blood Bank (Red Cross)',
      address:'N S Patkar Marg, Dadar (W), Mumbai 400 028',phone:'02224300300',
      latitude:19.0175,longitude:72.8445,timing:'8 AM – 6 PM',type:'Trust',area:'Dadar West'),
  BloodBank(id:'indian_red_cross',name:'Indian Red Cross Society Blood Bank',
      address:'Red Cross Building, Marine Lines, Mumbai 400 020',phone:'02222621664',
      latitude:18.9410,longitude:72.8290,timing:'9 AM – 5 PM',type:'Trust',area:'Marine Lines'),
  BloodBank(id:'rotary_bb',name:'Rotary Blood Bank',
      address:'Juhu Tara Rd, Santacruz (W), Mumbai 400 054',phone:'02226118885',
      latitude:19.0888,longitude:72.8264,timing:'9 AM – 6 PM',type:'Trust',area:'Santacruz West'),
];
...
List<BloodBank> _decodeCacheIsolate(String raw) =>
...
class NominatimService {
  ...
  static Future<List<NominatimResult>> search(String query,
    ...
    final res = await _client.get(uri, headers: _nominatimHeaders)
        .timeout(const Duration(seconds: 12));
...
class _BloodBankScreenState extends State<BloodBankScreen>
  ...
  void _recomputeStats() {
    ...
    _cachedGovt    = 0; _cachedPrivate = 0; _cachedTrust = 0;
    for (final b in _allBanks) {
      if (b.type == 'Government') _cachedGovt++;
      else if (b.type == 'Private') _cachedPrivate++;
      else if (b.type == 'Trust') _cachedTrust++;
    }
  }
  ...
  List<BloodBank> get _filtered {
    ...
    final bankHash = _allBanks.length ^
    (_allBanks.isEmpty ? 0 : _allBanks.first.id.hashCode) ^
    (_allBanks.isEmpty ? 0 : _allBanks.last.id.hashCode);
  ...
  List<Marker> _buildMarkers(List<BloodBank> filtered) {
    ...
    final bankHash = filtered.length ^
        ...
        child: GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color: isSel ? color : color.withOpacity(0.85),
            ...
            child: Icon(Icons.local_hospital,
                color: Colors.white, size: isSel ? 26 : 18),
          ),
        ),
      );
    }).toList();
  ...
  void _onSearchChanged(String value) {
    ...
    _debounce = Timer(const Duration(milliseconds: 350), () async {
      ...
      if (hits.isNotEmpty) {
        if (mounted) {
          _mapController.move(
              LatLng(hits.first.latitude, hits.first.longitude), 14.0);
        }
  ...
  Future<void> _launchCall(String phone) async {
    ...
    try { await launchUrl(Uri(scheme: 'tel', path: c)); }
    catch (_) { _snack('Could not open dialer.'); }
  }
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          const SizedBox(height: 14),
          Row(children: [
            Expanded(child: _contactBtn(Icons.call_rounded, 'Call',
                Colors.green[600]!,
                    () { Navigator.pop(ctx); _launchCall(phone); })),
            const SizedBox(width: 10),
            Expanded(child: _contactBtn(Icons.chat_rounded, 'WhatsApp',
                const Color(0xFF25D366),
                    () { Navigator.pop(ctx); _launchWhatsApp(phone); })),
            const SizedBox(width: 10),
            Expanded(child: _contactBtn(Icons.sms_rounded, 'SMS',
                Colors.blue[600]!,
            ...
            Material(
              ...
              child: Padding(
                ...
                child: Row(children: [
                  ...
                  IconButton(
                    icon: Icon(Icons.close, size: 16, color: Colors.amber[800]),
              ...
              child: Container(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    final shortName =
                    s.displayName.split(',').take(2).join(', ');
                    return ListTile(
                      dense: true,
                      leading:
          ...
          Container(
            ...
            child: Column(children: [
              Row(
                ...
                children: [
                  _statCard('Total',   _cachedTotal.toString(),   Colors.red[700]!),
                  _statCard('Govt',    _cachedGovt.toString(),    Colors.green[700]!),
                  _statCard('Private', _cachedPrivate.toString(), Colors.blue[700]!),
                  _statCard('Trust',   _cachedTrust.toString(),   Colors.orange[700]!),
                ],
              ),
              ...
              SingleChildScrollView(
                ...
                child: Row(
                  children: _typeFilters.map((t) => _filterChip(
                      ...
                      child: InkWell(
                        onTap: () {
                          setState(() {
                            ...
                            _searchController.text = _bloodGroupFilter ?? '';
                            _filteredCache         = null; // invalidate
                          });
                        },
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color:  active ? Colors.red[700] : Colors.red[50],
                            borderRadius: BorderRadius.circular(20),
                            border: Border.all(
                                color: active
                                    ? Colors.red[700]!
                          ...
                          child: Text(bg, style: TextStyle(
                              ...
                              color: active ? Colors.white : Colors.red[700])),
                        ),
                      ),
                    );
                  }),
            ...
            Expanded(
              child: GestureDetector(
                onTap: () {
                  ...
                  _mapController.move(
                      LatLng(bank.latitude, bank.longitude), 15.0);
                },
                child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ...
                      _infoRow(Icons.location_on, bank.address, Colors.grey[500]!),
                    ]),
              ),
            ),
            Container(
  ...
  Widget _buildEmpty() => Center(
    child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      ...
      const SizedBox(height: 12),
      Text('No blood banks match your search.',
